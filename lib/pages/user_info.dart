...
class SecondPage extends StatefulWidget {
 final String? email, name, password;
  ...
  SecondPage({super.key, required this.email, required this.name, required this.password});
...
registration() async {
  ...
  if (widget.password != null && _formKey.currentState!.validate()) {
    ...
    try {
      ...
      await addDetails(userCredential.user!.uid, widget.name!, widget.email!, address, deposit);
...
Future<void> addDetails(String uId, String name, String email, String address, int deposit) async {
                              ...
                              child: Column(
                                ...
                                [
                                  ...
                                  if (n == null) {
                                    ...
                                    if (n < 0 || n > 150) { // Assuming you want to limit the deposit amount
